...
const bakimlar = [
  {
    ...
    temizlik: [
      ...
      'Parfümsüz sabunlu eller ile nazikçe temizle',
  ...
  },
  {
    ...
    iyilesme: '3-6 ay',
    temizlik: [
      'Günde 2 kez tuzlu su spreyi kullan',
      'Steril serum fizyolojik ile hafifçe temizle',
  ...
  },
  {
    ...
    temizlik: [
      'Günde 2-3 kez tuzlu su ile nazikçe temizle',
      'Burun içini temizlerken pamuklu çubuk kullanma',
      'Steril gazlı bez tercih et',
    ],
    kacin: [
  ...
  },
  {
    ...
    iyilesme: '6-8 hafta',
    temizlik: [
      'Dıştan: Günde 2 kez tuzlu su ile temizle',
  ...
  },
  {
    ...
    iyilesme: '6-12 ay',
    temizlik: [
      'Günde 2 kez tuzlu su ile nazikçe temizle',
  ...
  },
  {
    ...
    ekbilgi: 'Vücut piercingı reddedebilir. Düzenli takip önemli!',
  },
]
  ...
  return (
    <main className="min-h-screen bg-gray-950 p-6">
      <div className="w-full max-w-lg mx-auto">
        ...
        <h1 className="text-2xl font-bold text-white mb-2">Bakim Talimatlari</h1>
        <p className="text-gray-400 mb-6">Piercing turunuze gore detayli bakim rehberi</p>

        <div className="bg-gray-800 rounded-2xl p-4 mb-6">
          <h2 className="text-white font-bold mb-3">Genel Bakim Kurallari</h2>
          <ul className="space-y-2">
            <li className="text-gray-300 text-sm">✅ Gunde 2 kez tuzlu su ile temizle</li>
            <li className="text-gray-300 text-sm">✅ Her temizlik oncesi elleri yika</li>
            <li className="text-gray-300 text-sm">✅ Kagit havlu ile kurula</li>
            <li className="text-red-400 text-sm">❌ Alkol, Betadin, oksijenli su kullanma</li>
        ...
        <h2 className="text-xl font-bold text-white mb-4">Piercing Turune Gore Bakim</h2>
          ...
          <div key={index} className="mb-3">
            ...
            >
              <div>
                ...
                <p className="text-orange-400 text-sm">İyilesme: {item.iyilesme}</p>
              </div>
            ...
            {acik === index && (
              <div className="bg-gray-900 rounded-b-2xl p-4 -mt-1">
                ...
                <h3 className="text-red-400 font-semibold mb-2">Kacinilmasi Gerekenler</h3>
        ...
        <div className="bg-gray-800 rounded-2xl p-4 mt-4">
          ...
          <p className="text-gray-400 text-sm mb-2">Su belirtileri gorursen piercerinle iletis:</p>
          <ul className="space-y-1">
            <li className="text-red-400 text-sm">🔴 Giderek artan kizariklik</li>
            <li className="text-red-400 text-sm">🔥 Ates (38°C uzeri)</li>
            <li className="text-red-400 text-sm">💧 Sari-yesil akinti</li>
            <li className="text-red-400 text-sm">😫 Siddetli agri</li>
            <li className="text-gray-400 text-sm">✅ Normal: Ilk gunler hafif kizariklik ve berrak akinti</li>
          </ul>
        </div>
      </div>
    </main>
