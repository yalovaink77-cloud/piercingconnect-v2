    ...
    <main className="min-h-screen bg-gray-950 p-6">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 gap-3 mb-8">
          <a href="/panel/randevular" className="bg-orange-500 text-white text-lg font-bold py-4 rounded-2xl text-center block">Randevular</a>
        ...
        <h2 className="text-xl font-bold text-white mb-4">Musteriler</h2>
        {loading && <p className="text-gray-400">Yukleniyor...</p>}
        {customers.map(c => (
          <a key={c.id} href={`/panel/musteri/${c.id}`} className="bg-gray-800 rounded-2xl p-4 mb-3 block">
